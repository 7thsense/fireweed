...
| PRD P0 queue-density item | PRD / TD-001 / TD-002 / TD-003 / TD-004 | E2 queue density: the release command `scripts/perf/tp002-e2-density-kind.sh` proves ≥1000 concurrently active queues on one live objectlog/SQLite node, each progress-eligible under bounded shared workers, with one hot queue preserving the E0 floor and numeric noisy-neighbor retention. `queue_density_single_node_tests` remains smoke-only supporting evidence. |
