...
import tempfile
import time
sys.path.insert(0, '/home/erik/Projects/fireweed/scripts/perf')
from workflow_storage_monitor import WalMonitor

repo = Path('/home/erik/Projects/fireweed')
binary = Path(os.environ["FIREWEED_DIAGNOSTIC_BINARY"])
args = sys.argv[1:]
...
workload_command = [str(binary), *args]
...
with tempfile.TemporaryFile() as stdout, tempfile.TemporaryFile() as stderr:
    ...
    # perf is a wrapper: find its actual workload child for memory sampling.
    monitored_pid = None
    for _ in range(1000):
