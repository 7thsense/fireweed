...
base=repo/'target/workflow-capacity/owned-params-counters-20260916'
...
recorder=Path('/tmp/fireweed-owned-params-counter-recorder.py');recorder.write_text(source)
...
for name,index,origin in [('candidate-1',0,head),('control',1,'64eb686f03ece8df75c3452be5c1a0b4d3cca066'),('candidate-2',0,head)]:
 ...
 provenance={'diagnostic_only':True,'build_source_head':origin,'executable_sha256':hashes[index],'recorder_source_head':head,'recorder_sha256':digest(recorder),'purpose':'one-cycle owned-parameter hardware-counter diagnostic; perf counts workload only; not sustained qualification'}
