...
assert not subprocess.run(['pgrep','-f','^'+str(Path('/tmp/fireweed-stack-symfs/home/erik/Projects/fireweed/target/release/fireweed-workload'))],capture_output=True).stdout.strip()
