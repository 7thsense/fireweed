...
| B-021 | Fault-injection harness | TP-003 §2, §3.10 | B-020 | `cargo test -p pqueue-storage fault_injection_harness_tests` | Shared replay, partial-append, deterministic failure scheduler, and reusable worker/service process-kill hooks used by AC-CLAIM-2, AC-SHARD-3, AC-E2E-2/3/5/7. |
...
| E3 object-log cost/ack/recovery evidence | B-081 | TP-002 E3 release benchmark |
...
`PQUEUE_BACKEND_PROFILE` and topology matrix required by TP-003 §3.10; commands
