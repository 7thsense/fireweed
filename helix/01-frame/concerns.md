...
| Whether Turso can serve as a Rust-native derived projection without becoming an authority or multiplying CI scale. | Selected behind a feature gate; production enablement is blocked on full SQLite differential, recovery, cancellation, and focused-CI evidence. | ADR-016, TD-010, TP-003 |
