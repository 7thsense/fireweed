use fireweed_core::{ItemId, QueueDefinition, RequestId};
use fireweed_engine::{
...
/// segment object name or manifest id) stored verbatim — fireweed-sqlite deliberately does NOT depend on
/// fireweed-objectlog types, so lineage crosses the crate boundary as opaque metadata.
