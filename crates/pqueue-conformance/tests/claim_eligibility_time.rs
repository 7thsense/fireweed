...
use pqueue_sqlite::{SqliteRelationalBackend, composed_sqlite_relational_in_memory};
...
async fn claim_with_explicit_eligibility_time_memory() {
    pqueue_conformance::scenarios::claim_with_explicit_eligibility_time(composed_memory_backend)
        .await;
}
...
async fn claim_with_explicit_eligibility_time_sqlite_relational() {
    pqueue_conformance::scenarios::claim_with_explicit_eligibility_time(|| {
