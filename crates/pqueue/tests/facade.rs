...
impl pqueue::Clock for GuardedClock {
...
async fn reclaim_expired_at_honors_caller_time_without_reading_handle_clock() {
    ...
    let control_plane: Arc<dyn pqueue_engine::QueueControlPlane> = Arc::new(
        pqueue_engine::InMemoryControlPlane::new(ControlPlaneConfig::default()),
    );
