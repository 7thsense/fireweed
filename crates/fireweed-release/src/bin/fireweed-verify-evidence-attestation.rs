...
use fireweed_release::attestation::{load_attestation, verify_attestation};
...
fn usage(message: &str) -> ! {
    ...
    eprintln!(
        "usage: fireweed-verify-evidence-attestation --manifest <json> --repo-root <dir> --tag <vX.Y.Z> --commit <40-char-sha>"
    );
    std::process::exit(2)
}
