...
/// [`fireweed_engine::EngineError::Unavailable`] — a consumer must reject it before activation.
impl fireweed_engine::CommitTransitionPort for ObjectLogBackend {}
...
impl fireweed_engine::SetGatesPort for ObjectLogBackend {}
...
impl fireweed_engine::ReschedulePort for ObjectLogBackend {}

// Active-scope discovery is a relational-class feature (per-group summary); the object-log family refuses it.
impl fireweed_engine::DiscoveryPort for ObjectLogBackend {}
...
impl fireweed_engine::RecoveryReadPort for ObjectLogBackend {}
...
impl fireweed_engine::HotProjectionQueryPort for ObjectLogBackend {}
