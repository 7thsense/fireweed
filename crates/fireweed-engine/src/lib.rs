...
pub use claim_batch::{
    ...
    SharedDriverReadAdmission, SlotAcquire, SlotPermit, audited_append_admission_count,
    audited_append_request_admission_count, audited_mutation_sequencer_join,
    mutation_generation_disposition, mutation_generation_disposition_for_commands,
};
