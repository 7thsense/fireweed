...
pub use compose::{
    ...
    claim_by_query_body_hash, commit_body_hash, definition_page_from_sorted_rows,
    definition_page_from_storage_rows, item_mutation_fingerprint, max_position,
    outcome_entry_from_recovery, outcomes_from_recovery, plan_batch_update,
