...
use pqueue_objectlog::{AsyncObjectLog, GroupCommitObjectLogProjectionCommitter};
...
impl ObjectLogTursoBackend {
    pub async fn open_with_blob_store(
        ...
        let committer = GroupCommitObjectLogProjectionCommitter::open_shared(
            ...
            Vec::new(),
            pqueue_objectlog::MAX_RECOVERY_PAGE_SIZE,
            1024,
        )
        .await?;
        let strategy =
    ...
    async fn claimed_targets(
        ...
        shard: &QueueKey,
        ids: &[ItemId],
    ) -> EngineResult<Vec<pqueue_engine::ClaimedItem>> {
...
impl pqueue_engine::CommitTransitionPort for ObjectLogTursoBackend {}
impl pqueue_engine::RecoveryReadPort for ObjectLogTursoBackend {}
